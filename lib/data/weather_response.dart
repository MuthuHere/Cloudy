...
import 'package:weatherapp/utils/temperature_conversion.dart';
import 'package:weatherapp/utils/weather_icons.dart';

///api response model for below apis'
///1. location apis' based on selected city
///2. location api based on your current location
class WeatherDetails {
  ...
  static WeatherDetails fromJson(Map<String, dynamic> json) {
